...
//
///**
// * Created by bhaskarravi on 12/14/13.
// */
//public class AutoSimulationSocialSwayRapid {
//
...
//        objTEST.readData(bidDataTEST, adGroupDataTEST, "/Users/bhaskarravi/Desktop/SimulationDBs/Autos/Autos_BiddingSim_TEST.csv");
//
...
//
//        //Header
//        System.out.println("CAMPAIGN VERTICAL: AUTOS");
...
//                if(likesReg.predict(hour+1) > 25 && likes[hour - 1] > 6){ //9 is the mean # of likes for the training set, 36 is the average of the high dist.
//                    //MAKE CPA ONLY BID
//                    timeList.add(adGroupDataTEST.get(hour).getTimeStamp());
//                    impressionsList.add(adGroupDataTEST.get(hour).getUniqueImpressions());
//                    clicksList.add(adGroupDataTEST.get(hour).getUniqueClicks());
...
//
//                    if((impressionsReg.predict(hour+1) * costPerThousand[hour]) / 1000 > (clicksReg.predict(hour+1) * costPerClick[hour]) || likes[hour - 1] > 6){
//                        //BID CPC NOT CPM
//                        timeList.add(adGroupDataTEST.get(hour).getTimeStamp());
//                        impressionsList.add(adGroupDataTEST.get(hour).getUniqueImpressions());
//                        clicksList.add(adGroupDataTEST.get(hour).getUniqueClicks());
