 ...
 */
public class HealthSimulationSocialSway {
    public static void main(String[] args) {
        ...
        objTEST.readData(bidDataTEST, adGroupDataTEST, "/Users/bhaskarravi/Desktop/Health_BiddingSim_TEST.csv");
        ...
        while(totalLikes < likesGoal){
            ...
            if(hour < 12){
                ...
                hourlyCost = (costPerThousand[hour]*adGroupDataTEST.get(hour).getUniqueImpressions()/1000) +
                        ...
                        (costPerAction[hour]* (likesList.get(hour)));;
                ...
                if(likesReg.predict(hour+1) > 10 && likes[hour - 1] > 2){ //3 is the mean # of likes for the training set, 13 is the average of the high dist.
                    //MAKE CPA ONLY BID
                    timeList.add(adGroupDataTEST.get(hour).getTimeStamp());
                    impressionsList.add(adGroupDataTEST.get(hour).getUniqueImpressions());
                    clicksList.add(adGroupDataTEST.get(hour).getUniqueClicks());
