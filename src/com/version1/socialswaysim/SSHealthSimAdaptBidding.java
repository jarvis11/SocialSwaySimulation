 ...
 */
public class SSHealthSimAdaptBidding {
    ...
    public static void main(String[] args) {
        ...
        objTEST.readData(bidDataTEST, adGroupDataTEST, "/Users/bhaskarravi/Desktop/Health_BiddingSim_TEST_AdaptiveBidding.csv");
        ...
        while(totalLikes < likesGoal){
            ...
            if(hour < 12){
                ...
                if(likesReg.predict(hour+1) > 17 && likes[hour - 1] > 3){ //3 is the mean # of likes for the training set, 13 is the average of the high dist.
                    //MAKE CPA ONLY BID
                    timeList.add(adGroupDataTEST.get(hour).getTimeStamp());
                    impressionsList.add(adGroupDataTEST.get(hour).getUniqueImpressions());
                    clicksList.add(adGroupDataTEST.get(hour).getUniqueClicks());
                    ...
                    if(likesReg.predict(hour+1) < 17 && likes[hour - 1] > 3){
